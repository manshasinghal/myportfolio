    ...
    <ul className='nav '>
    {
      List1.map(({path,name})=>(
        ...
        <Link to={path} smooth={true} duration={500}>{name}</Link>
          ...
          <li className="ml-12 text-gray-400 font-bold text-xl cursor-pointer hover:text-gray-200 ease-in duration-300">
          <a  href="https://drive.google.com/file/d/1lrtY5lZb_c0kUONZWu2DqmOFmYIXhApN/view?usp=sharing" target="_blank" rel="noopener noreferrer">Resume</a>
          </li>
        </ul>
      </div>
