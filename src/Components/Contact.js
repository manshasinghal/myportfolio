  ...
  return (
    <div className="bg-black text-white px-12 pb-12 pt-36" id='contact'>
      <div className="text-center mb-8">
        ...
        <div className="bg-orange-400 w-[180px] h-[2px] m-auto"></div>
      </div>
       ...
       {showMessage && (
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              className="bg-orange-400 text-black p-1  mt-4 w-[80px] hover:translate-y-[-2px] ease-in duration-300"
            >
              Send
            </button>
          </div>
        ...
        >
          <div className="ml-32 mt-8">
            ...
            <div className="flex justify-between mt-12 ">
              ...
              <div className="h-[200px] w-[2px] bg-orange-400"></div>
              <div>
                <div className="mb-4">
